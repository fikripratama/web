<?php	
		...
		$modul = '';
			...
			{
				$first = true;
				foreach ($_POST['modul'] as $mdl){
					if(strcmp($mdl, 'lain')==0){
						$temp = ( isset($_POST['modullain']) ) ? $_POST['modullain'] : '';
						$mdl = "Lain: ".$temp;
					}
		...
		$lamapakai = ( isset($_POST['lamapakai']) ) ? $_POST['lamapakai'] : '';
		...
		$choice = array($P1,$P2,$P3,$P4,$P5,$P6,$P7,$P8,$P9,$P10,
